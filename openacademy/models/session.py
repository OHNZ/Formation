...
class Session(models.Model):
     ...
     def regrouper_participant(self):
          list = []
          for r in self:

               particulier = r.participant_ids.filtered(lambda x: x.company_type == 'person')
               societe = r.participant_ids.filtered(lambda x: x.company_type == 'company')
               list.append(particulier)
               list.append(societe)
               print('=======================',particulier,"societe",societe,list)
          return list
